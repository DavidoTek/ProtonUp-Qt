...
CT_DESCRIPTION['en'] = '''Compatibiliteitshulpmiddel 'Wine' voor het spelen van Windows-games op Linux. Dit hulpmiddel is gebaseerd op Valve Proton Experimental's Wine en is gemaakt voor Lutris.<br/><br/><b>Bij twijfel, kies dit.</b>'''
